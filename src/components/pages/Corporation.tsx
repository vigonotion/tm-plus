...
import {RecentGamesTables} from "@/components/pages/Player.tsx";
  ...
  const placements = data.expand?.["placements(corp)"];
    ...
    return (
        <div>
            ...
            {placements && <RecentGamesTables placements={placements.sort((a, b) => b.expand?.game?.date.localeCompare(a.expand?.game?.date ?? "") ?? 0)}/>}
        </div>
    );
}
